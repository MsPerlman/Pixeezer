        ...
        item(span = { GridItemSpan(maxLineSpan) }) {
            androidx.compose.foundation.layout.Row(
                ...
                androidx.compose.material3.Icon(
                        ...
                        contentDescription = stringResource(R.string.content_desc_toggle_grid_list)
                    )
                }
            }
        }
...
private fun GenreCard(
    ...
    val shape = rememberAppTileShape(20.dp, smoothWhenDefault = false)
        ...
        BoxWithConstraints(
            ...
            Box(
                ...
                SmartImage(
                    ...
                    contentDescription = stringResource(R.string.content_desc_genre_illustration),
                    modifier = Modifier
                        .fillMaxSize()
                        .alpha(0.55f),
