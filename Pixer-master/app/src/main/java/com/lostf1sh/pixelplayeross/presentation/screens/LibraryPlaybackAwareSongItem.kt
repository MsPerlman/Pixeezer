...
internal fun LibraryPlaybackAwareSongItem(
    ...
    // The swipe gesture itself lives inside EnhancedSongListItem so every screen gets it;
    // this wrapper only forwards whether it's allowed here.
    EnhancedSongListItem(
        ...
        swipeToQueueEnabled = swipeToQueueEnabled,
