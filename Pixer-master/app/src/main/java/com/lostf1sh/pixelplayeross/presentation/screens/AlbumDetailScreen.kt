        ...
        CollapsibleCommonTopBar(
            ...
            actions = {
                com.lostf1sh.pixelplayeross.presentation.components.PinToHomeIconButton(
                    type = com.lostf1sh.pixelplayeross.data.preferences.PinnedItemType.ALBUM,
                    id = album.id.toString(),
                    label = album.title,
                    imageUrl = album.albumArtUriString,
                ...
                FilledIconButton(
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.content_desc_like_album),
